                        ...
                        <div key={index}>
                            <div className="w-full gap-y-2">
                                <div className="flex gap-2 items-center">
                                    <FolderCopyOutlined className="text-2xl text-amber-950 font-semibold " />
                                    <span className="font-raleway text-2xl lg:text-3xl text-amber-950 font-semibold ">
                                        {project.title}
                                    </span>
                                </div>

                                <div className="flex gap-2 items-center mt-1">
                                    <CalendarMonthOutlined className="text-2xl text-amber-950 font-semibold " />
                                ...
                                <div className="mt-3">
                                    <p
                                        className="font-montserrat text-sm lg:text-base text-red-950 leading-relaxed"
