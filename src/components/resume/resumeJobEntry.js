              ...
              <div key={index}>
                <div className="w-full gap-y-2">
                  <div className="flex gap-2 items-center">
                    <PersonOutline className="text-2xl text-slate-900 dark:text-white" />
                  ...
                  <div className="flex gap-2 items-center mt-1">
                    <CalendarMonth className="text-2xl text-slate-900 dark:text-white" />
                  ...
                  <p
                    className="font-montserrat text-sm lg:text-base mt-3 text-slate-800 dark:text-slate-200 leading-relaxed"
